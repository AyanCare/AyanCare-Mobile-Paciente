...
fun ModalAddChronicDiseases(
    ...
    var validateGrau by rememberSaveable {
        mutableStateOf(true)
    }

    val validateNameError = "Nome está em branco"
    val validateGrauError = "Grau está em branco"
    ...
    fun validateData(
        ...
        validateGrau = grau.isNotBlank()

        return validateName && validateGrau
    }
...
//                    )
                    CustomTextFieldValidate(
                        ...
                        onValueChange = { grauState = it },
                        label = "Grau:",
                        showError = !validateGrau,
                        errorMessage = validateGrauError,
                        keyboardOptions = KeyboardOptions(
                            keyboardType = KeyboardType.Text,
